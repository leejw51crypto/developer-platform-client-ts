...
export class Block {
   ...
   * @returns {Promise<ApiResponse>} - A promise that resolves to the block data.
   ...
   * console.log(block);
   */
  public static async getBlockByTag(blockTag: string, txDetail?: string): Promise<ApiResponse> {
